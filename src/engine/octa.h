...
struct surfaceinfo {
	...
	int totalverts() const {
		return numverts & MAXFACEVERTS;
	}
	bool used() const {
		return (numverts & ~LAYER_TOP) != 0;
	}
	void clear() {
		numverts = (numverts & MAXFACEVERTS) | LAYER_TOP;
	}
	void brighten() {
		clear();
	}
...
struct vtxarray {
	...
	int verts, tris, texs, blendtris, blends, alphabacktris, alphaback, alphafronttris, alphafront, refracttris,
		refract, texmask, sky, matsurfs, matmask, distance, rdistance, dyntexs, decaltris, decaltexs;
	ivec o;
...
#define loopoctabox(o, size, bbmin, bbmax)                  \
	uchar possible = octaboxoverlap(o, size, bbmin, bbmax); \
	loopi(8) if (possible & (1 << i))
#define loopoctaboxsize(o, size, bborigin, bbsize)                                  \
	uchar possible = octaboxoverlap(o, size, bborigin, ivec(bborigin).add(bbsize)); \
	loopi(8) if (possible & (1 << i))

enum { O_LEFT = 0, O_RIGHT, O_BACK, O_FRONT, O_BOTTOM, O_TOP, O_ANY };
...
#define GENFACEVERTSX(x0, x1, y0, y1, z0, z1, c0, c1, r0, r1, d0, d1) \
	GENFACEORIENT(0,                                                  \
				  GENFACEVERTX(0, 0, x0, y1, z1, d0, r1, c1),         \
				  GENFACEVERTX(0, 1, x0, y1, z0, d0, r1, c0),         \
				  GENFACEVERTX(0, 2, x0, y0, z0, d0, r0, c0),         \
				  GENFACEVERTX(0, 3, x0, y0, z1, d0, r0, c1))         \
	GENFACEORIENT(1,                                                  \
				  GENFACEVERTX(1, 0, x1, y1, z1, d1, r1, c1),         \
				  GENFACEVERTX(1, 1, x1, y0, z1, d1, r0, c1),         \
				  GENFACEVERTX(1, 2, x1, y0, z0, d1, r0, c0),         \
				  GENFACEVERTX(1, 3, x1, y1, z0, d1, r1, c0))
...
#define GENFACEVERTSY(x0, x1, y0, y1, z0, z1, c0, c1, r0, r1, d0, d1) \
	GENFACEORIENT(2,                                                  \
				  GENFACEVERTY(2, 0, x1, y0, z1, c1, d0, r1),         \
				  GENFACEVERTY(2, 1, x0, y0, z1, c0, d0, r1),         \
				  GENFACEVERTY(2, 2, x0, y0, z0, c0, d0, r0),         \
				  GENFACEVERTY(2, 3, x1, y0, z0, c1, d0, r0))         \
	GENFACEORIENT(3,                                                  \
				  GENFACEVERTY(3, 0, x0, y1, z0, c0, d1, r0),         \
				  GENFACEVERTY(3, 1, x0, y1, z1, c0, d1, r1),         \
				  GENFACEVERTY(3, 2, x1, y1, z1, c1, d1, r1),         \
				  GENFACEVERTY(3, 3, x1, y1, z0, c1, d1, r0))
...
#define GENFACEVERTSZ(x0, x1, y0, y1, z0, z1, c0, c1, r0, r1, d0, d1) \
	GENFACEORIENT(4,                                                  \
				  GENFACEVERTZ(4, 0, x0, y0, z0, r0, c0, d0),         \
				  GENFACEVERTZ(4, 1, x0, y1, z0, r0, c1, d0),         \
				  GENFACEVERTZ(4, 2, x1, y1, z0, r1, c1, d0),         \
				  GENFACEVERTZ(4, 3, x1, y0, z0, r1, c0, d0))         \
	GENFACEORIENT(5,                                                  \
				  GENFACEVERTZ(5, 0, x0, y0, z1, r0, c0, d1),         \
				  GENFACEVERTZ(5, 1, x1, y0, z1, r1, c0, d1),         \
				  GENFACEVERTZ(5, 2, x1, y1, z1, r1, c1, d1),         \
				  GENFACEVERTZ(5, 3, x0, y1, z1, r0, c1, d1))
