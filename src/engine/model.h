enum { MDL_MD5 = 0, MDL_OBJ, NUMMODELTYPES };
...
struct model {
	...
	virtual int intersect(int anim,
						  int basetime,
						  int basetime2,
						  const vec& pos,
						  float yaw,
	...
	virtual bool pitched() const {
		return true;
	}
	virtual bool alphatested() const {
		return false;
	}
